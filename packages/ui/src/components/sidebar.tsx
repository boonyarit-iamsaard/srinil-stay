...
const SIDEBAR_WRAPPER_VARS: CSSPropertiesWithVars = {
  "--sidebar-width": SIDEBAR_WIDTH,
  "--sidebar-width-icon": SIDEBAR_WIDTH_ICON,
};

const SIDEBAR_MOBILE_VARS: CSSPropertiesWithVars = {
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        style={{ ...SIDEBAR_WRAPPER_VARS, ...style }}
        {...props}
      >
        {children}
      </div>
