...
- [x] Staff can deactivate an active Unit without hard-deleting it.
- [x] Staff can reactivate an inactive Unit.
- [x] The back-office Unit list clearly distinguishes active and inactive Units.
- [x] Active-state API access is Staff-only.
- [x] The slice includes focused server tests for deactivate/reactivate behavior
      and Staff-only access.
- [x] Reactivation does not manage date-specific availability.
