...
namespace SrinilStay.Api.Data.Migrations
{
    ...
    [Migration("20260513084525_CreateRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SrinilStay.Api.Authentication.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SrinilStay.Api.Authentication.RefreshToken", b =>
                {
                    b.HasOne("SrinilStay.Api.Authentication.RefreshToken", "ReplacedByToken")
                        .WithMany()
